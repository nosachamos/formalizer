...
#### [v1.0.0-rc.12](https://github.com/nosachamos/formalizer/compare/v1.0.0-rc.12...v1.0.0-rc.12)
...
- Updates to the API to add support for radio buttons. Changes to the API so that the checkbox support is in line with the radio buttons. [`a801ecb`](https://github.com/nosachamos/formalizer/commit/a801ecbc23930a0f3f0caecccddbb81dda6082cb)
